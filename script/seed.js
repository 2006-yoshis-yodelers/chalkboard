...
async function seed() {
  ...
  const wolfram = await User.findOne({
    where: {
  ...
  // await c5.update({teacherId: wolfram.id})
  const c6 = await Course.findByPk(6)
  await c6.update({teacherId: wolfram.id})
  // const c7 = await Course.findByPk(7)
  // await c7.update({ teacherId: wolfram.id })
  // const c8 = await Course.findByPk(8)
  // await c8.update({ teacherId: wolfram.id })
  // // const c9 = await Course.findByPk(9)
  // // await c9.update({teacherId: wolfram.id})
  // const c10 = await Course.findByPk(10)
  // await c10.update({ teacherId: wolfram.id })
  // const c11 = await Course.findByPk(11)
  // await c11.update({ teacherId: wolfram.id })
  // const c12 = await Course.findByPk(12)
  // await c12.update({ teacherId: wolfram.id })
  // const c13 = await Course.findByPk(13)
  // await c13.update({ teacherId: wolfram.id })
  // const c14 = await Course.findByPk(14)
  // await c14.update({ teacherId: wolfram.id })
  ...
  // await courseEcon201.update({ teacherId: wolfram.id })
  // await courseSenCod404.update({ teacherId: wolfram.id })
  // await courseReacto202.update({ teacherId: wolfram.id })
